package com.flocier.test.infrastructure;

import com.alibaba.fastjson.JSON;
import com.flocier.infrastructure.persistent.dao.IRaffleActivityOrderDao;
...
public class RaffleActivityOrderDaoTest {
    ...
    public void test_insert() {
        ...
        raffleActivityOrder.setUserId("flocier");
